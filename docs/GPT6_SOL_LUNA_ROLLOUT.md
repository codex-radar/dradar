...
D0132-REAL-01/02 authorize at most four ds0 isolated subscription trials, medium, concurrency 1, no retries/refill, $5 per task and $20 total hard API-equivalent budget, with account/resource exclusion and quota prerequisites. No trial started: the existing official adapter cannot establish a cumulative successful-request/token upper bound; a single conservative Sol long-context request reserve can reach $6.53. Timeouts or post-hoc kill do not satisfy that hard budget. No gateway/interceptor was built. See the local budget-preflight evidence for exact inspected sources. Real execution, grading, returned-model identity, complete actual usage, independent QA and production release remain unverified.
